...
export const profile = {
  ...
  about: [
    ...
    "Works in AI-assisted development daily — Claude Code, Cursor, GitHub Copilot — keeping planning, architecture, and code review human-led while delegating implementation to AI for fast, reviewable output without sacrificing quality.",
